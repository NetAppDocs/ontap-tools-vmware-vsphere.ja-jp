...
+
を参照してください link:../deploy/reference_deployment_customization_requirements.html["導入のカスタマイズに関する考慮事項"] を参照してください。
...
link:../deploy/task_register_oncommand_api_services_with_ONTAP_tools.html["ONTAP ツールへの OnCommand API サービスの登録"]
